    ...
    <Link to={'/signup'} className='text-blue-600'> Create new Account</Link></p>
        ...
        <div>
            <Link to={'/captain-login'} 
             className='flex items-center mb-5 justify-center  bg-[#10b461] text-white font-semibold rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as Captain
             </Link>
        </div>
    </div>
     </>
